...
async def start(update, context):
    ...
    webapp_url = os.getenv("WEBAPP_URL", "https://1893-194-164-216-167.ngrok-free.app")
...
async def handle_callback(update, context):
    ...
    try:
        ...
        if query.data == 'pricing':
            ...
            keyboard = [
                [telegram.InlineKeyboardButton("📧 Написать на Malina2701@mail.ru", url="mailto:Malina2701@mail.ru")],
